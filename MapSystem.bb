			...
			If r\grid\grid[x+(y*gridsz)]>0 Then
				...
				Select r\grid\grid[x+(y*gridsz)]
					...
					Case ROOM4+2
						...
						it = CreateItem("Antidote Bottle","scp500",r\x+x*2.0+(Cos(EntityYaw(tile_entity,True))*(-208.0)*RoomScale)-(Sin(EntityYaw(tile_entity,True))*1226.0*RoomScale),8.0+(80.0*RoomScale),r\z+y*2.0+(Sin(EntityYaw(tile_entity,True))*(-208.0)*RoomScale)+(Cos(EntityYaw(tile_entity,True))*1226.0*RoomScale))
						EntityType (it\collider, HIT_ITEM)
...
;			EntityParent dp\cam,fr\Forest_Pivot
			...
			it = CreateItem("What is Xen?", "paper", r\x + 672.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 335.0 * RoomScale)
			RotateEntity it\collider, 0, r\angle+10, 0
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Xen Survey Method #11", "paper", r\x + 1152.0 * RoomScale, r\y + 176.0 * RoomScale, r\z - 384.0 * RoomScale)
		...
		Case "room372"
			;[Block]
			it = CreateItem("Xenocephmacro Imperium Document", "paper", r\x + 800.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 1108.0 * RoomScale)
		...
		Case "room2storage"
			...
			it = CreateItem("Gastropolypus Toxophlegmata Document", "paper", r\x + 352.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 256.0 * RoomScale)
			...
			it = CreateItem("HEV Battery", "hevbat", r\x + 672 * RoomScale, 176.0 * RoomScale, r\z + 220.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2sroom"
			...
			it = CreateItem("Rad Bottle", "420", r\x + 1776.0 * RoomScale, r\y + 400.0 * RoomScale, r\z + 427.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Rad Bottle", "420", r\x + 1808.0 * RoomScale, r\y + 400.0 * RoomScale, r\z + 435.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2shaft"
			...
			it = CreateItem("Medical Kit", "firstaid", r\x + 1035.0 * RoomScale, r\y + 145.0 * RoomScale, r\z + 56.0 * RoomScale)
		...
		Case "room2poffices"
			...
			EntityParent(it\collider, r\obj)	
			it = CreateItem("HEV Battery", "hevbat", r\x + 608.0 * RoomScale, r\y + 112.0 * RoomScale, r\z + 32.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 90, 0)
			
			it = CreateItem("Emergency Report", "paper", r\x + 704.0 * RoomScale, r\y + 183.0 * RoomScale, r\z - 576.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			it = CreateItem("Note to Dr. Kleiner", "paper", r\x + 912 * RoomScale, r\y + 176.0 * RoomScale, r\z - 160.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			it = CreateItem("Medical Kit", "firstaid", r\x + 912.0 * RoomScale, r\y + 112.0 * RoomScale, r\z - 336.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 90, 0)
			;[End Block]
		Case "room2poffices2"
			;[Block]
		...
		Case "room2cafeteria"
			...
			it = CreateItem("Coin", "25ct", r\x-447.0*RoomScale, r\y-334.0*RoomScale, r\z+36.0*RoomScale)
			EntityParent(it\collider, r\obj)
			it = CreateItem("Coin", "25ct", r\x+1409.0*RoomScale, r\y-334.0*RoomScale, r\z-732.0*RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room2nuke"
			;[Block]
			...
			it = CreateItem("HEV Battery", "hevbat", r\x - 944.0 * RoomScale, r\y + 1652.0 * RoomScale, r\z - 656.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, -90, 0)
...
;			
		...
		Case "room008"
			...
			PositionEntity(r\Objects[1], r\x + 292 * RoomScale, r\y - 4954.0 * RoomScale, r\z + 576.0 * RoomScale, True)
			...
			d = CreateDoor(r\zone, r\x + 296.0 * RoomScale, r\y - 5105.0 * RoomScale, r\z - 672.0 * RoomScale, 180, r, True, 0, 4)
			d\AutoClose = False
			...
			d = CreateDoor(r\zone, r\x - 384.0 * RoomScale, r\y - 5105.0 * RoomScale, r\z - 672.0 * RoomScale, 0, r, False, 0, 4)
			...
			r\RoomDoors[4] = CreateDoor(r\zone, r\x + 799.0 * RoomScale, r\y - 5105.0 * RoomScale, r\z - 287.0 * RoomScale, 90, r, False, 3)
            r\RoomDoors[4]\AutoClose = False : r\RoomDoors[0]\open = True
			
			it = CreateItem("Cleansuit", "hazmatsuit", r\x - 76.0 * RoomScale, r\y - 4895.0 * RoomScale, r\z - 396.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 90, 0)
			
			it = CreateItem("Keplar Virus Document", "paper", r\x - 545.0 * RoomScale, r\y - 4895.0 * RoomScale, r\z + 368.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity it\collider, 0, 0, 0
			
			it = CreateItem("HEV Battery", "hevbat", r\x - 545.0 * RoomScale, r\y - 4925.0 * RoomScale, r\z + 535.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 0, 0)
            ...
            r\Objects[10] = CreatePivot()
			PositionEntity(r\Objects[10], r\x + 292.0 * RoomScale, r\y - 4985.0 * RoomScale, r\z + 155.5555 * RoomScale)
			EntityParent(r\Objects[10], r\obj)
		...
		Case "room035"
			...
			it = CreateItem("Cleanup Procedures", "paper", r\x + 248.0 * RoomScale, r\y + 220.0 * RoomScale, r\z + 576.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Radio Transceiver", "radio", r\x - 544.0 * RoomScale, 0.5, r\z + 704.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Antidote Bottle", "scp500", r\x + 1168 * RoomScale, 224.0 * RoomScale, r\z + 576.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("HEV Battery", "hevbat", r\x + 1168 * RoomScale, 164.0 * RoomScale, r\z + 400.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Xenium Metal Panel", "scp148", r\x - 360 * RoomScale, 0.5, r\z + 644.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Xenocephalo Brachymus Document", "paper", r\x + 1168.0 * RoomScale, 104.0 * RoomScale, r\z + 608.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room513"
			;[Block]
			...
			it = CreateItem("Briefcase", "scp513", r\x - 32.0 * RoomScale, r\y + 196.0 * RoomScale, r\z + 688.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Blood-stained Note", "paper", r\x + 736.0 * RoomScale,1.0, r\z + 48.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Foreboding Note", "paper", r\x - 480.0 * RoomScale, 104.0*RoomScale, r\z - 176.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room966"
			;[Block]
		...
		Case "room049"
			...
			it = CreateItem("Note from CJ #2", "paper", r\x - 608.0 * RoomScale, r\y - 3332.0 * RoomScale, r\z + 876.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Level 4 Key Card", "key4", r\x - 512.0 * RoomScale, r\y - 3412.0 * RoomScale, r\z + 864.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Medical Kit", "firstaid", r\x +385.0 * RoomScale, r\y - 3412.0 * RoomScale, r\z + 271.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room012"
			...
			it = CreateItem("DD-7382 Document", "paper", r\x - 56.0 * RoomScale, r\y - 576.0 * RoomScale, r\z - 408.0 * RoomScale)
			EntityParent(it\collider, r\obj)
...
;			PositionEntity(r\Objects[6], r\x - 848*RoomScale, 0.5, r\z-576*RoomScale, True)
		...
		Case "room3servers"
			...
			r\Objects[3] = CopyEntity(o\NPCModelID[23])
		...
		Case "room3servers2"
			...
			it = CreateItem("Weird Letter", "paper", r\x + 960.0 * RoomScale, r\y - 448.0 * RoomScale, r\z + 251.0 * RoomScale)
			RotateEntity it\collider, 0, r\angle, 0
			EntityParent(it\collider, r\obj)		
			
			it = CreateItem("HEV Battery", "hevbat", r\x + 954.0 * RoomScale, r\y - 504.0 * RoomScale, r\z + 235.0 * RoomScale)
			EntityParent(it\collider, r\obj)		
			;[End Block]
		Case "room2testroom"
			;[Block]
			...
			;r\Objects[8] = CreatePivot()
			;PositionEntity(r\Objects[8], r\x - 800.0 * RoomScale, -1280.0 * RoomScale, r\z + 2.3)
			;EntityParent(r\Objects[8], r\obj)
			
			;r\Objects[9] = CreatePivot()
			;PositionEntity(r\Objects[9], r\x - 800.0 * RoomScale, -1280.0 * RoomScale, r\z - 2.3)
			;EntityParent(r\Objects[9], r\obj)
			
			;For i = 8 To 9
			;	r\Objects[i]\DisableWaypoint = True
			;Next
			
			it = CreateItem("Xenotaur Gargantua Document", "paper", r\x + 656.0 * RoomScale, r\y - 1200.0 * RoomScale, r\z - 16.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room2closets"
			;[Block]
			it = CreateItem("Chumtoads Document", "paper", r\x + 736.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 736.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("HEV Helmet", "gasmask", r\x + 736.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 544.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			...
			it = CreateItem("Xenotherium Monopscelida Document", "paper",r\x + 736.0 * RoomScale, r\y + 224.0 * RoomScale, r\z -480.0 * RoomScale)
		...
		Case "room2offices"
			;[Block]
			it = CreateItem("Xenotherium Subservilia Document", "paper", r\x + 404.0 * RoomScale, r\y + 145.0 * RoomScale, r\z + 559.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2offices2"
			...
			it = CreateItem("Lambda Reactor #1386 Protocol", "paper", r\x - 800.0 * RoomScale, r\y - 48.0 * RoomScale, r\z + 368.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			If Rand(2) = 1 Then
				it = CreateItem("Xen Survey Method #11", "paper", r\x - 800.0 * RoomScale, r\y - 48.0 * RoomScale, r\z - 464.0 * RoomScale)
			Else
				it = CreateItem("Xenotherium Tentaculus Document", "paper", r\x - 800.0 * RoomScale, r\y - 48.0 * RoomScale, r\z - 464.0 * RoomScale)
			EndIf
			EntityParent(it\collider, r\obj)
			...
			r\Objects[0] = CopyEntity(o\NPCModelID[23])
		...
		Case "room2offices3"
			;[Block]
			If Rand(2)=1 Then 
				it = CreateItem("Military Units", "paper", r\x + 744.0 * RoomScale, r\y +240.0 * RoomScale, r\z + 944.0 * RoomScale)
				EntityParent(it\collider, r\obj)	
			Else
			...
			it = CreateItem("Threat Levels", "paper", r\x + 160.0 * RoomScale, r\y +240.0 * RoomScale, r\z + 568.0 * RoomScale)
			EntityParent(it\collider, r\obj)	
			...
			it = CreateItem("HEV Battery", "hevbat", r\x - 1440.0 * RoomScale, r\y + 563.0 * RoomScale, r\z - 800.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "start"
			...
			d.Doors = CreateDoor(r\zone, r\x + 1280.0 * RoomScale, 383.9*RoomScale, r\z + 312.0 * RoomScale, 180, r, True)
			d\locked = True : d\AutoClose = False
		...
		Case "room2scps"
			...
			it = CreateItem("HEV Upgrade: Memetic Shield", "scp714", r\x - 552.0 * RoomScale, r\y + 220.0 * RoomScale, r\z - 760.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("HEV Upgrade: Health Regulator", "scp1025", r\x + 552.0 * RoomScale, r\y + 224.0 * RoomScale, r\z - 758.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Prototype Micro-Reactor", "scp860", r\x + 568.0 * RoomScale, r\y + 178.0 * RoomScale, r\z + 760.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			...
			it = CreateItem("Regarding Failed HEV Upgrades", "paper", r\x - 728.0 * RoomScale, r\y + 288.0 * RoomScale, r\z - 360.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Mobile Recharger Document", "paper", r\x - 608.0 * RoomScale, r\y + 66.0 * RoomScale, r\z + 636.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room895"
			...
			it = CreateItem("Lambda Reactor #1386 Protocol", "paper", r\x - 688.0 * RoomScale, r\y + 133.0 * RoomScale, r\z - 304.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "914"
			...
			it = CreateItem("Non-Relay Teleport Protocol", "paper", r\x +954.0 * RoomScale, r\y +228.0 * RoomScale, r\z + 127.0 * RoomScale)
			EntityParent(it\collider, r\obj)	
			
			it = CreateItem("Medical Kit", "firstaid", r\x + 960.0 * RoomScale, r\y + 112.0 * RoomScale, r\z - 40.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 90, 0)
		...
		Case "173"
			...
			CreateItem("Assignment Sheet", "paper", r\x-(2910+1024)*RoomScale, 170.0*RoomScale, r\z-35*RoomScale)
			CreateItem("Walker's Badge", "badge", r\x-4250*RoomScale, 250.0*RoomScale, r\z+320*RoomScale)
			
			it = CreateItem("HEV Suit", "vest", r\x-(2910+1024)*RoomScale, 82.0*RoomScale, r\z+280*RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2ccont"
			...
			it = CreateItem("Note from Dr. Keller", "paper", r\x-400.0*RoomScale,1040.0*RoomScale,r\z+115.0*RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room106" ;(Upgraded by Ultimate Edition)
			...
			it = CreateItem("Dr. Thompson's Note", "paper", r\x - 416.0 * RoomScale, r\y - 7904.0 * RoomScale, r\z + 2428.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Teleport Interference Protocol", "paper", r\x + 268.0 * RoomScale, r\y - 7904.0 * RoomScale, r\z + 2529.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			...
			r\RoomDoors[1]\AutoClose = False
			PositionEntity(r\RoomDoors[1]\buttons[0], EntityX(r\RoomDoors[1]\buttons[0], True) + 0.014, EntityY(r\RoomDoors[1]\buttons[0], True), EntityZ(r\RoomDoors[1]\buttons[0], True), True)
			PositionEntity(r\RoomDoors[1]\buttons[1], EntityX(r\RoomDoors[1]\buttons[1], True) - 0.014, EntityY(r\RoomDoors[1]\buttons[1], True), EntityZ(r\RoomDoors[1]\buttons[1], True), True)
			
            ;others
			d = CreateDoor(r\zone, r\x - 968.0 * RoomScale, r\y - 8092.0 * RoomScale, r\z + 1328.0 * RoomScale, 0, r, False, False, 4)
			d\AutoClose = False : d\open = False
			...
			d = CreateDoor(r\zone, r\x, r\y - 7328.0 * RoomScale, r\z - 529.0 * RoomScale, 0, r, False, False, 4)
			d\AutoClose = False : d\open = False
			PositionEntity(d\buttons[0], EntityX(d\buttons[0], True), EntityY(d\buttons[0], True), EntityZ(d\buttons[0], True) + 0.029, True)
			PositionEntity(d\buttons[1], EntityX(d\buttons[1], True), EntityY(d\buttons[1], True), EntityZ(d\buttons[1], True) - 0.028, True)
			
			d = CreateDoor(r\zone, r\x - 624.0 * RoomScale, r\y - 8608.0 * RoomScale, r\z - 64.0 * RoomScale, 90, r, False, False, 4)
			d\AutoClose = False : d\open = False
			PositionEntity(d\buttons[0], EntityX(d\buttons[0], True) - 0.028, EntityY(d\buttons[0], True), EntityZ(d\buttons[0], True), True)
			PositionEntity(d\buttons[1], EntityX(d\buttons[1], True) + 0.028, EntityY(d\buttons[1], True), EntityZ(d\buttons[1], True), True)
					...
					For ztemp = 0 To 2
						...
						Select True
							...
							Case (chance<40) ;40% chance for a document
								...
								Select Rand(1,6)
									Case 1
										tempstr="Note from CJ #1" ;1123
									Case 2
										tempstr="Chumtoads Document" ;1048
									Case 3
										tempstr="Gastropolypus Toxophlegmata Document" ;939
									Case 4
										tempstr="Xenotaur Gargantua Document" ;682
									Case 5
										tempstr="Announcement System Notice" ;079
									Case 6
										tempstr="Xenotherium Myrmex Document" ;096
									Case 6
										tempstr="Shock Troopers Document" ;966
								End Select
								tempstr2="paper"
		...
		Case "room1123"
			;[Block]
			it = CreateItem("Note from CJ #1", "paper", r\x + 511.0 * RoomScale, r\y + 125.0 * RoomScale, r\z - 936.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Small Crystal", "1123", r\x + 832.0 * RoomScale, r\y + 166.0 * RoomScale, r\z + 784.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Leaflet", "paper", r\x - 816.0 * RoomScale, r\y + 704.0 * RoomScale, r\z+ 888.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("HEV Helmet", "gasmask", r\x + 457.0 * RoomScale, r\y + 150.0 * RoomScale, r\z + 960.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2servers2"
			...
			it = CreateItem("HEV Battery", "hevbat", r\x + 56.0154 * RoomScale, r\y - 648.0 * RoomScale, r\z + 749.638 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		...
		Case "room1162"
			...
			it = CreateItem("Office Maintenance Schedule", "paper", r\x + 863.227 * RoomScale, r\y + 152.0 * RoomScale, r\z - 953.231 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2scps2"
			...
			it = CreateItem("Displacer Gun", "scp1499", r\x + 600.0 * RoomScale, r\y + 176.0 * RoomScale, r\z - 228.0 * RoomScale)
			RotateEntity it\collider, 0, r\angle, 0
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Displacer Cannon Document", "paper", r\x + 840.0 * RoomScale, r\y + 260.0 * RoomScale, r\z + 224.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Power-Up Bottles Description", "paper", r\x + 1152.0 * RoomScale, r\y + 224.0 * RoomScale, r\z + 336.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Azian Vance's Badge", "badge", r\x + 364.0 * RoomScale, r\y + 5.0 * RoomScale, r\z + 716.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2offices4"
			...
			it = CreateItem("Note from the Administrator", "paper", r\x - 991.0*RoomScale, r\y - 242.0*RoomScale, r\z + 904.0*RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room2sl"
			;[Block]
			...
			r\Textures[0] = LoadAnimTexture("GFX\SL_monitors_checkpoint.jpg",1,512,512,0,3)
			r\Textures[1] = LoadAnimTexture("GFX\Sl_monitors.jpg",1,256,256,0,8)
			r\Textures[2] = LoadAnimTexture("GFX\Sl_monitors2.jpg", 1, 512, 512, 0, 3)
				...
				If i <> 7 Then
					...
					If i <> 4 And i <> 13 Then
						...
						Select i
							...
							Default
								EntityTexture screen, r\Textures[0], 2
						End Select
...
;			RotateEntity r\Objects[21],8.6,-150.0,-5.0
		...
		Case "medibay"
			...
			it = CreateItem("Medical Kit", "firstaid", r\x - 506.0 * RoomScale, r\y + 192.0 * RoomScale, r\z - 322.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room009" ;Ultimate Edition room.
			;[Block]
			;doors				
			r\RoomDoors[0] = CreateDoor(r\zone, r\x, r\y, r\z - 640.0 * RoomScale, 0, r, False, 2, 3)
			r\RoomDoors[0]\AutoClose = False
			
			r\RoomDoors[1] = CreateDoor(r\zone, r\x + 640.0 * RoomScale, r\y, r\z, 90, r, True, 2, 3)
			r\RoomDoors[1]\AutoClose = False : r\RoomDoors[1]\locked = True : r\RoomDoors[1]\MTFClose = False : r\RoomDoors[1]\DisableWaypoint = True
			
			r\RoomDoors[2] = CreateDoor(r\zone, r\x - 640.0 * RoomScale, r\y, r\z, 90, r, False, 2, 3)
			r\RoomDoors[2]\AutoClose = False
			
			r\RoomDoors[3] = CreateDoor(r\zone, r\x - 831.0 * RoomScale, r\y, r\z + 352.0 * RoomScale, 0, r, True, False, 3)
			...
			r\RoomDoors[4] = CreateDoor(r\zone, r\x + 831.0 * RoomScale, r\y, r\z + 352.0 * RoomScale, 180, r, False, False, 3)
			...
			d = CreateDoor(r\zone, r\x + 655.0 * RoomScale, r\y , r\z - 655.0 * RoomScale, 135, r, False, 2, -1)
			d\AutoClose = False
		...
		Case "room409"
			...
			d = CreateDoor(r\zone, r\x - 4336.0 * RoomScale, r\y - 4528.0 * RoomScale, r\z + 1552.0 * RoomScale, 0, r, False, False, 4)
			d\AutoClose = False
			PositionEntity(d\buttons[0], EntityX(d\buttons[0], True), EntityY(d\buttons[1], True), EntityZ(d\buttons[0], True) + 0.062, True)
			PositionEntity(d\buttons[1], EntityX(d\buttons[1], True), EntityY(d\buttons[1], True), EntityZ(d\buttons[1], True) - 0.062, True)					
			
			;If diceroll = 3 And (Not diceroll = 2) Then
			;	it = CreateItem("SCP-005", "scp005", r\x - 4951.0 * RoomScale, r\y - 4688.0 * RoomScale, r\z + 1828.0 * RoomScale)
			;	EntityParent(it\collider, r\obj)	
			;EndIf
				
			it = CreateItem("XF-4090 Document", "paper", r\x - 3595.0 * RoomScale, r\y - 4608.0 * RoomScale, r\z + 2234.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 0, 0)
			
			it = CreateItem("HEV Battery", "hevbat", r\x - 3595.0 * RoomScale, r\y - 4763.0 * RoomScale, r\z + 2360.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			...
			r\RoomDoors[1]\AutoClose = False : r\RoomDoors[1]\open = False	
			PositionEntity(r\RoomDoors[1]\buttons[0], EntityX(r\RoomDoors[1]\buttons[0], True) + 0.03, EntityY(r\RoomDoors[1]\buttons[1], True), EntityZ(r\RoomDoors[1]\buttons[0], True), True)
			PositionEntity(r\RoomDoors[1]\buttons[1], EntityX(r\RoomDoors[1]\buttons[1], True) - 0.03, EntityY(r\RoomDoors[1]\buttons[1], True), EntityZ(r\RoomDoors[1]\buttons[1], True), True)					
		...
		Case "room457" ;Nine Tailed Fox Mod room (Upgraded by Ultimate Edition).
			...
			d = CreateDoor(r\zone, r\x + 8064.0 * RoomScale, r\y - 3072.0 * RoomScale, r\z + 1248.0 * RoomScale, 0, r, False, False, 3)
			d\AutoClose = False
			...
			r\RoomDoors[1]\AutoClose = False
			PositionEntity(r\RoomDoors[1]\buttons[0], EntityX(r\RoomDoors[1]\buttons[0], True) + 0.03, EntityY(r\RoomDoors[1]\buttons[0], True), EntityZ(r\RoomDoors[1]\buttons[0], True), True)
			PositionEntity(r\RoomDoors[1]\buttons[1], EntityX(r\RoomDoors[1]\buttons[1], True) - 0.03, EntityY(r\RoomDoors[1]\buttons[1], True), EntityZ(r\RoomDoors[1]\buttons[1], True), True)
			
			r\RoomDoors[2] = CreateDoor(r\zone, r\x - 264.0 * RoomScale, r\y - 3072.0 * RoomScale, r\z - 656.0 * RoomScale, 90, r, False, 3)
			r\RoomDoors[2]\AutoClose = False
			PositionEntity(r\RoomDoors[2]\buttons[0], EntityX(r\RoomDoors[2]\buttons[0], True) + 0.03, EntityY(r\RoomDoors[2]\buttons[0], True), EntityZ(r\RoomDoors[2]\buttons[0], True), True)
			PositionEntity(r\RoomDoors[2]\buttons[1], EntityX(r\RoomDoors[2]\buttons[1], True) - 0.03, EntityY(r\RoomDoors[2]\buttons[1], True), EntityZ(r\RoomDoors[2]\buttons[1], True), True)
			
			r\RoomDoors[3] = CreateDoor(r\zone, r\x + 264.0 * RoomScale, r\y - 3072.0 * RoomScale, r\z + 656.0 * RoomScale, 90, r, False, 3)
			r\RoomDoors[3]\AutoClose = False
			PositionEntity(r\RoomDoors[3]\buttons[0], EntityX(r\RoomDoors[3]\buttons[0], True) + 0.03, EntityY(r\RoomDoors[3]\buttons[0], True), EntityZ(r\RoomDoors[3]\buttons[0], True), True)
			PositionEntity(r\RoomDoors[3]\buttons[1], EntityX(r\RoomDoors[3]\buttons[1], True) - 0.03, EntityY(r\RoomDoors[3]\buttons[1], True), EntityZ(r\RoomDoors[3]\buttons[1], True), True)
			...
			d = CreateDoor(r\zone, r\x + 2832.0 * RoomScale, r\y - 3072.0 * RoomScale, r\z + 2372.0 * RoomScale, 90, r, False, 3)
			d\AutoClose = False : d\locked = True : d\DisableWaypoint = True
			FreeEntity(d\buttons[0]) : d\buttons[0] = 0
			PositionEntity(d\buttons[1], EntityX(d\buttons[1], True) + 0.062, EntityY(d\buttons[1], True), EntityZ(d\buttons[1], True), True)
			...
			;items
			it = CreateItem("Sactildiae Nefariousium Document", "paper", r\x + 1728.0 * RoomScale, r\y - 2682.0 * RoomScale, r\z - 128.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("9V Battery", "bat", r\x + 1070.0 * RoomScale, r\y - 2886.0 * RoomScale, r\z + 258.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("HEV Battery", "hevbat", r\x + 8358.0 * RoomScale, r\y - 2886.0 * RoomScale,r\z + 775.0 * RoomScale)
			EntityParent(it\collider, r\obj)
            ...
            ;lever
			r\Objects[9] = CopyEntity(LeverOBJ)
			...
			r\Objects[10] = CopyEntity(LeverObj)
		...
		Case "room4info"
			...
			it = CreateItem("Radio Transceiver", "fineradio", r\x + 650.0 * RoomScale, r\y + 258.0 * RoomScale, r\z - 775.0 * RoomScale)
			EntityParent(it\collider, r\obj)			
			...
			If EntityDistance(Collider,s\obj)<1.2 Then
				...
				If PickedEntity()=s\obj And s\imgpath<>"" Then
					...
					If MouseUp1 Then 
						...
						PlaySound_Strict MonitorClickSFX
						MouseUp1=False
					EndIf
				EndIf
			EndIf
		...
		Else
			...
			If close = True Then
				If sc\Screen Then
					...
					If Sanity < (-1000) Then 
						DeathMSG = "SUBJECT: [CLASSIFIED] | STATUS: DEAD | "
						DeathMSG = DeathMSG + "POST-MORTEM: Subject died of cardiac arrest due to extradimensional hallucinogetic attack."
...
Function CreateMap()
	...
	MapRoom(ROOM2, Room2Amount[0]+Floor(0.35*Float(Room2Amount[1]))) = "room008"
	SetRoom("room049", ROOM2, Room2Amount[0]+Floor(0.4*Float(Room2Amount[1])),min_pos,max_pos)
	SetRoom("room409", ROOM2, Room2Amount[0] + Floor(0.5 * Float(Room2Amount[1])), min_pos, max_pos)
	...
	SetRoom("room457", ROOM2, Room2Amount[0] + Floor(0.8 * Float(Room2Amount[1])), min_pos, max_pos)
