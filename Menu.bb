...
Function UpdateMainMenu()
	...
	If MenuBlinkTimer(1) < MenuBlinkDuration(1) Then
		...
		If MenuBlinkTimer(1) < 0 Then
			...
			Select Rand(0, 22)
				Case 0, 2, 3
					MenuStr = "UNFORESEEN CONSEQUENCES"
				Case 4, 5
					MenuStr = "At Black Mesa, we deliver the future."
				Case 6, 7, 8
					MenuStr = "RESONANCE CASCADE"
				Case 9, 10, 11
					MenuStr = "Welcome to the HEV Mark IV."
				Case 12, 19
					MenuStr = "fak u taci-senpai"
				Case 13
					MenuStr = "We have complete confidence in you."
				Case 14
					MenuStr = "DIE"
				Case 15
					MenuStr = "YOU CANNOT WIN"
				Case 16
					MenuStr = "7816"
				Case 17
					MenuStr = "The time is 8:47AM"
				Case 18
					MenuStr = "ERROR"
				Case 20
					MenuStr = "Far, distant eyes look out through yours."
				Case 21
					MenuStr = "Check out Loompa Land"
				Case 22
					MenuStr = "You can never know the truth."
			End Select
		EndIf
	EndIf
		...
		Select MainMenuTab
			...
			Case 3,5,6,7 ;options
				...
				ElseIf MainMenuTab = 6 ;Controls
					...
					AAText(x + 280 * MenuScale, y + 100 * MenuScale, "Take Screenshot")
					InputBox(x + 470 * MenuScale, y + 100 * MenuScale,100*MenuScale,20*MenuScale,KeyName(Min(KEY_SCREENSHOT,210)),13)
					If CanOpenConsole	
					    AAText(x + 280 * MenuScale, y + 120 * MenuScale, "Open/Close Console")
					    InputBox(x + 470 * MenuScale, y + 120 * MenuScale,100*MenuScale,20*MenuScale,KeyName(Min(KEY_CONSOLE,210)),12)
					EndIf
				...
				ElseIf MainMenuTab = 7 ;Advanced
					...
					If CanOpenConsole
					    ...
					    If ConsoleVersion = 1 Then
							AAText(x + 350 * MenuScale, y, "New")
					    Else
					        AAText(x + 350 * MenuScale, y, "Old")
					    EndIf    
					    If MouseOn(x+310*MenuScale,y+MenuScale,20*MenuScale,20*MenuScale)
	...
	AAText 20,GraphicHeight-70,"v"+VersionNumber
	AAText 20,GraphicHeight-50,"Running on SCP:CB v1.3.11"
	AAText 20,GraphicHeight-30,"Made by Resonance Breach Team. Credits to Valve, Gearbox & Crowbar Collective"
...
Function UpdateLauncher()
	...
	Font1 = LoadFont_Strict("GFX\font\trebuc\Trebuchet MS.ttf", 20, 0,0,0)
	SetFont Font1
	MenuWhite = LoadImage_Strict("GFX\menu\menuwhite.jpg")
	MenuBlack = LoadImage_Strict("GFX\menu\menublack.jpg")	
	MaskImage MenuBlack, 255,255,0
	...
	ButtonMenuSFX% = LoadSound_Strict("SFX\Interact\ButtonMenu.ogg")
	Local i%	
	...
	AppTitle "SCP:CB - Half-Life Resonance Cascade Launcher"
		...
		If SelectedLoadingScreen\title = "CWM" Then
			...
			If percent = 0 Then 
				...
				Else
					Select Rand(10)
						Case 1
							SelectedLoadingScreen\txt[0] = "Prepare for Unforseen Consequences"
						Case 2
							SelectedLoadingScreen\txt[0] = "Kilo Lima India"
						Case 3
							SelectedLoadingScreen\txt[0] = "It's not shutting down"
						Case 4
							SelectedLoadingScreen\txt[0] = "Trust me"
						Case 5 
							SelectedLoadingScreen\txt[0] = "Is it really that time again?"
						Case 6
							SelectedLoadingScreen\txt[0] = "It will happen on May 16th, 2001"
						Case 7
							SelectedLoadingScreen\txt[0] = "8:47AM"
						Case 8
							SelectedLoadingScreen\txt[0] = "Rise and shine, Mr. Walker."
						Case 9
							SelectedLoadingScreen\txt[0] = "The right man in the wrong place can make all the difference in the world."
						Case 10
							SelectedLoadingScreen\txt[0] = "Wake up and smell the ashes."
					End Select
				EndIf
			EndIf
...
Function DrawOptionsTooltip(x%,y%,width%,height%,option$,value#=0,ingame%=False)
	...
	Select Lower(option$)
		...
		Case "consoleversion"
		    txt = "This function changes your console to old or new version."
		Case "achpopup"
