...
ButtonSFX3 = LoadSound_Strict("SFX\Interact\Button3.ogg")
ScannerSFX1 = LoadSound_Strict("SFX\Interact\ScannerUse1.ogg")
ScannerSFX2 = LoadSound_Strict("SFX\Interact\ScannerUse2.ogg")
MonitorClickSFX = LoadSound_Strict("SFX\Interact\MonitorClick.ogg")
...
Gunshot1SFX% = LoadSound_Strict("SFX\General\Gunshot1.ogg")
...
;SCP-009 alarm (with geiger)
AlarmSFX(5) = LoadSound_Strict("SFX\Alarm\Alarm6.ogg")
...
Ambient1123SFX% = LoadSound_Strict("SFX\SCP\1123\Ambient.ogg")

;Global ScientistRadioSFX
ScientistRadioSFX = LoadSound_Strict("SFX\Character\Scientist\Radio.ogg")

;Global GunShot4SFX%
Gunshot4SFX% = LoadSound_Strict("SFX\General\Gunshot3.ogg")

;Global VehicleSFX
VehicleSFX = LoadSound_Strict("SFX\Room\Intro\VehicleMove.ogg")
